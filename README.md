...
I'm a 1st-year Computer Science student building toward a career in cybersecurity — aiming for a SOC Analyst or Security Analyst internship by summer 2027.

## What I'm currently learning

- **TryHackMe** — Pre Security path (networking, Linux, web fundamentals)
- **Hack The Box Academy** — Junior Cybersecurity Analyst path
- **Cisco NetAcad** — Introduction to Cybersecurity, Networking Basics
...
- NetAcad: Introduction to Cybersecurity *(in progress)*
- TryHackMe SEC1 *(in progress)*
- HTB CJCA *(in progress)*

## CTF & Lab Writeups

I document everything I learn. Check my writeups repo below — every TryHackMe room and HTB box I complete gets a writeup.
